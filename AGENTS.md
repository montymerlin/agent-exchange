# AGENTS.md — Agent Exchange Workshop
...
- AGENTS.md (this file) is the canonical agent instruction set
- CLAUDE.md is a thin compatibility wrapper for Claude-oriented runtimes
...
- **File creation:** Use the scaffold files themselves as teaching examples
...
2. **Dual-audience documentation** — README.md serves humans. AGENTS.md serves agents. Keep them distinct. Don't collapse human-readable overviews into agent instructions or vice versa.
...
<!-- Scaffold sources: Anthropic Agent Skills principles, progressive disclosure (Krug; Nielsen Norman Group), convention over configuration (Rails/DHH) -->
